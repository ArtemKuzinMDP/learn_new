...
## Типы ОС по отношению к пользователям:
- однопользовательские и однозадачные (в один момент - одна программа, только один тип пользователей, отсутствует разграничение доступов до своих ресурсов)
- однопользовательская и многозадачная (в один момент может выполняться несколько программ, но все еще присутствует только один тип пользователей)
- многопользовательские и многозадачные (в единицу времени может исполняться несколько программ, имеется механизм ограничения доступа до ресурса)
