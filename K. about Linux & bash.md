...
- proc (виртуальная файловая система, состояние ядра ОС в виде запущенных файлов, является каталогом процессов, параметров ядра и драйверов.), 
...
- less - режим просмотра в терминале.Управление - стрелки, Пейдж ап и даун. Q - выход. Через / поиск по документу.
...
- more - постраничный вывод файла или результата процесса в терминале. Вниз листать можно, вверх - нет.
...
- Через значок | связывается последовательность команд от первой до последней.
