...
1. GREP - global regular expression print. утилита для поиска информации по конкретным ключам в конкретном файле. grep, далее в кавычках текст поиска, с учетом регистра, в конце файл, в котором нужно смотреть. -iубирает зависимость от регистра. 
